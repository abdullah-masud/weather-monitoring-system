    ...
    <div className="bg-base-200 min-h-screen">
      ...
      >
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-md">
            <h1 className="text-5xl font-bold">Smart Weather Monitoring System</h1>
            <p className="py-6">
              Real-time weather insights powered by IoT sensors. Stay updated with accurate data on temperature, humidity, rainfall, and more.
            </p>
            <Link to="/dashboard">
      ...
      <div className="p-10 text-center">
        ...
        <p className="max-w-2xl mx-auto">
          This Smart Weather Monitoring System uses advanced IoT sensors to track and display real-time environmental data.
          Designed for smart cities and eco-conscious planning, our system enhances decision-making through live data visualization.
        </p>
      </div>
      ...
      <div className="p-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-shadow duration-300">
          <div className="card-body">
            ...
            <p>Monitors temperature, humidity, rainfall, UV intensity, and air quality.</p>
          </div>
        </div>
        ...
        <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-shadow duration-300">
          <div className="card-body">
            ...
            <p>Use historical data and trends for smarter decisions in planning.</p>
          </div>
        </div>
      </div>
      ...
      <div className="stats shadow m-10">
        <div className="stat">
          ...
          <div className="stat-desc">Temperature, Humidity, Rainfall, UV, Air Quality</div>
        </div>
      ...
      <footer className="footer footer-center p-4 bg-base-300 text-base-content">
        <p>© 2025 Smart Weather Monitoring Team. All rights reserved.</p>
      </footer>
    </div>
  );
};
